  ...
  _handleSprintStatus(data, res) {
    ...
    const payload = {
      ...
      sprint: {
        ...
        claim_count: sprint.claim_count ?? 0,
        phase: sprint.phase || "unknown",
        conflict_count: sprint.conflict_count ?? 0,
        compile_status: sprint.compile_status || "unknown",
        certificate: sprint.certificate || null,
        timestamp: sprint.timestamp || Date.now(),
      },
    };
