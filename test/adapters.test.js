...
describe('BaseAdapter', () => {
  ...
  it('provides default formatTimeoutResponse', () => {
    ...
    assert.ok(result.hookSpecificOutput.permissionDecisionReason.includes('timed out'));
  });
});
...
describe('ClaudeCodeAdapter', () => {
  ...
  describe('formatResponse', () => {
    it('formats PreToolUse allow', () => {
      ...
      assert.equal(result.hookSpecificOutput.permissionDecisionReason, 'Approved');
    });
    ...
    it('formats PreToolUse deny', () => {
      ...
      assert.equal(result.hookSpecificOutput.permissionDecision, 'deny');
      assert.equal(result.hookSpecificOutput.permissionDecisionReason, 'Too risky');
    });
    ...
    it('formats AskUserQuestion deny-to-respond pattern', () => {
      ...
      assert.equal(result.hookSpecificOutput.permissionDecision, 'deny');
      assert.equal(result.hookSpecificOutput.permissionDecisionReason, 'Use option B');
    });
